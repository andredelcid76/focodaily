...
//   "Revisar contrato @45 !urgente"
//   "@30" → duration 30 min, "!urgente|!importante|!circ" → category
function parseLine(raw: string, defaults: { duration: number; category: TaskCategory }): LineParse | null {
  const line = raw.trim();
  if (!line) return null;
  let title = line;
