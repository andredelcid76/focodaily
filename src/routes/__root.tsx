...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Tarefas, projetos, delegação e agenda da equipe em um só lugar, com Outlook, Teams e Fireflies." },
      { property: "og:title", content: "Foco — Gestão de tarefas" },
      { name: "twitter:title", content: "Foco — Gestão de tarefas" },
      { property: "og:description", content: "Tarefas, projetos, delegação e agenda da equipe em um só lugar, com Outlook, Teams e Fireflies." },
      { name: "twitter:description", content: "Tarefas, projetos, delegação e agenda da equipe em um só lugar, com Outlook, Teams e Fireflies." },
      { name: "twitter:card", content: "summary" },
      { property: "og:type", content: "website" },
      { name: "theme-color", content: "#0f141b" },
